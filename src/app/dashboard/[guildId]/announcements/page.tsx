...
function normalizeDraft(key: string, input: any): AnnouncementDraft {
  ...
  return {
    ...
    thumbnail_game_name: typeof source.thumbnail_game_name === "string" ? source.thumbnail_game_name : "",
                ...
                {activeDraft.post_type === "plain" ? (
                  ...
                  <AdvancedEmbedEditor
                    config={{
                      ...
                      thumbnail_game_name: activeDraft.thumbnail_game_name,
