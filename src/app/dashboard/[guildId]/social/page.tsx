  ...
  const sourcePlaceholder =
    activeMonitor?.platform === "youtube"
      ...
      : activeMonitor?.platform === "tiktok"
        ? "TikTok @username or URL (RSSHub, etc.)"
        : "RSS/Atom URL";
            ...
            {activeMonitor ? (
              <div className="flex flex-col gap-6 h-full">
                ...
                <div className="rounded-xl border border-[#1E1F22] bg-[#202225]/80 p-4 text-xs text-discord-text-muted space-y-2">
                  <div>
                    <span className="text-white font-semibold">Resolved Source:</span>{" "}
                    {lastTestResult?.resolved_source_url || "Run Test Source to view"}
                  </div>
